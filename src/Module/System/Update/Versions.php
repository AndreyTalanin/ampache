...
{
    public const MAXIMUM_UPDATABLE_VERSION = 760002; // AMPACHE_VERSION (db_version)
    ...
    private static array $versions = [
        ...
        701001 => Migration\V7\Migration701001::class,
        701002 => Migration\V7\Migration701002::class,
        702001 => Migration\V7\Migration702001::class,
        702002 => Migration\V7\Migration702002::class,
        710001 => Migration\V7\Migration710001::class,
        710002 => Migration\V7\Migration710002::class,
        710003 => Migration\V7\Migration710003::class,
        710004 => Migration\V7\Migration710004::class,
        ...
        740001 => Migration\V7\Migration740001::class,
        750001 => Migration\V7\Migration750001::class,
        750002 => Migration\V7\Migration750002::class,
        750003 => Migration\V7\Migration750003::class,
        750004 => Migration\V7\Migration750004::class,
        750006 => Migration\V7\Migration750006::class,
        750007 => Migration\V7\Migration750007::class,
        750008 => Migration\V7\Migration750008::class,
        750009 => Migration\V7\Migration750009::class,
        750010 => Migration\V7\Migration750010::class,
        751001 => Migration\V7\Migration751001::class,
        752001 => Migration\V7\Migration752001::class,
        760001 => Migration\V7\Migration760001::class,
        760002 => Migration\V7\Migration760002::class,
    ];
